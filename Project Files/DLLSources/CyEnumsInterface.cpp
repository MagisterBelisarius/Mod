...
void CyEnumsPythonInterface()
{
	...
	python::enum_<ButtonPopupTypes>("ButtonPopupTypes")
		...
		.value("BUTTONPOPUP_SAVE_CITYGROUP", BUTTONPOPUP_SAVE_CITYGROUP) //R&R mod, vetiarvind, trade groups 
	...
	python::enum_<CommandTypes>("CommandTypes")
		...
		.value("COMMAND_ASSIGN_CITY_TRANSPORT", COMMAND_ASSIGN_CITY_TRANSPORT)
